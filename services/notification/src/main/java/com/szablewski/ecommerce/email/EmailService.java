...
import com.szablewski.ecommerce.kafka.order.Product;
...
import static com.szablewski.ecommerce.email.EmailTemplate.ORDER_CONFIRMATION;
import static com.szablewski.ecommerce.email.EmailTemplate.PAYMENT_CONFIRMATION;
...
public class EmailService {
    ...
    public void sendPaymentSuccessEmail(String destinationEmail, String customerName, BigDecimal amount, String orderReference) throws MessagingException {
        ...
        messageHelper.setFrom("szabello18@gmail.com");
        final String templateName = PAYMENT_CONFIRMATION.getTemplate();

        Map<String, Object> variables = getPaymentVariables(customerName, amount, orderReference);
    ...
    public void sentOrderConfirmationEmail(String destinationEmail, String customerName, BigDecimal amount, String orderReference, List<Product> products) throws MessagingException {
        ...
        Map<String, Object> variables = getOrderVariables(customerName, amount, orderReference, products);
